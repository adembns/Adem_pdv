 ...
 */
final class Version20240303100621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article1_user1 (article1_id INT NOT NULL, user1_id INT NOT NULL, INDEX IDX_B727C9F12FA7667A (article1_id), INDEX IDX_B727C9F156AE248B (user1_id), PRIMARY KEY(article1_id, user1_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
